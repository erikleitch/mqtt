...
#ifndef NIFUTIL_ERLUTIL_H
#define NIFUTIL_ERLUTIL_H
...
#define STRING_CONV_FN(fn) ERL_NIF_TERM (fn)(ErlNifEnv* env, std::string str)

typedef ERL_NIF_TERM (*STRING_CONV_FN_PTR)(ErlNifEnv* env, std::string str);
...
namespace nifutil {
    ...
    public:
        ...
        static STRING_CONV_FN(stringToInt64Term);
        static STRING_CONV_FN(stringToUint64Term);
        static STRING_CONV_FN(stringToBinaryTerm);
        static STRING_CONV_FN(stringToBooleanTerm);
        static STRING_CONV_FN(stringToDoubleTerm);

        static STRING_CONV_FN_PTR getStringConvFn(std::string type);
...
#endif // End #ifndef NIFUTIL_ERLUTIL_H
